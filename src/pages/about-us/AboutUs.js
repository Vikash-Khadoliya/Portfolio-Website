    ...
    <div className="about" id="about">
      ...
      <div className="container data">
        ...
        <div className="content">
          ...
          <p className="pad2">
            Hii, I am a MERN Stack developer based in Rajasthan, India. I am an
            undergraduate student of the Bachelor of Computer Application at
            Seth G.B. Podar College, Nawalgarh (Raj.). I am very passionate
